...
def create_random_splines_within_curve(n_splines=100, n_nodes_per_spline=100, name='Curve > hair', mesh_data=None):
    """
    ...
    for spline_id in range(n_splines):
        ...
        spline = create_spline(curve.data, s_type, len_nodes, spline_id, n_splines, bud_position)
...
if ref_ob is not None:
    mesh_data = suzanne.data
curve = create_random_splines_within_curve(20000, 50, mesh_data)